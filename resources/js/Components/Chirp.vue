...
<template>
    <div class="p-6 flex space-x-2">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-green-600 -scale-x-100" fill="none" viewBox="0 0 24 24" 
        ...
        <div class="flex-1">
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <small v-if="chirp.created_at !== chirp.updated_at" class="text-sm text-green-600"> &middot; edited</small>
                </div>
                ...
                <template #content>
                    <button class="block w-full px-4 py-2 text-left text-sm leading-5 text-gray-700 hover:bg-gray-100 focus:bg-gray-100 
                    transition duration-150 ease-in-out" @click="editing = true">
                        Edit
                    </button>
